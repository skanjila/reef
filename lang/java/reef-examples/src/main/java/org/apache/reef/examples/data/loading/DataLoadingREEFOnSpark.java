...
public final class DataLoadingREEFOnSpark {
  ...
  public static void main(final String[] args)
    ...
    spark = SparkSession.builder().appName("DataLoadingReefOnSparkApplication").enableHiveSupport().getOrCreate();
    inputDataFrame = spark.read().json("examples/src/main/resources/people.json");
