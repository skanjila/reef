...
/**
 * The driver component for the SparkDataLoadingService
...
public class SparkDataLoader {
  ...
  private static final Logger LOG = Logger.getLogger(SparkDataLoader.class.getName());
  ...
  public SparkDataLoader(
      ...
      @Parameter(SparkDataLoadingRequestBuilder.DataLoadingComputeRequests.class)
      final Set<String> serializedComputeRequests,
      @Parameter(SparkDataLoadingRequestBuilder.DataLoadingDataRequests.class)
  ...
  /**
   * A custom start handler for the Spark Data Loader.
   */
  ...
  /**
   * A custom evaluator allocator strategy for spark.
   */
  ...
  /**
   * A strategy for failed evaluator handler requests.
   */
